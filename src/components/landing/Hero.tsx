        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <span className="text-sm font-medium text-primary">Elite Dashboard Control</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight-custom leading-[0.95] mb-6"
            >
              <span className="text-gradient-hero">Stop Chasing.</span>
              <br />
            ...
            >
              We're Your Shortcut to Closed Deals
            </motion.p>
            ...
            >
              <Button asChild size="lg" className="relative bg-secondary hover:bg-secondary/90 text-secondary-foreground px-8 py-7 text-lg font-semibold group overflow-hidden">
                <Link to="/signup">
              ...
              <Button asChild variant="outline" size="lg" className="border-2 border-border hover:border-primary/50 hover:bg-muted px-8 py-7 text-lg font-medium group">
                <Link to="/login">
                  <span className="group-hover:text-primary transition-colors">Login to Your Dashboard</span>
                </Link>
              </Button>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-muted-foreground/80"
            >
          ...
          {/* Right: Mobile Mockup with 3D Effect */}
          <motion.div
          ...
          >
            ...
            >
              ...
              {/* Phone frame */}
              <div className="relative bg-gradient-to-br from-slate-900 to-slate-950 p-3 rounded-[2.5rem] border-4 border-slate-800 shadow-2xl">
