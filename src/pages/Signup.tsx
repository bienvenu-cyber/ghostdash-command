  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <h1 className="text-3xl font-black tracking-tight-custom text-foreground mb-2">Get Instant Access</h1>
        <p className="text-muted-foreground mb-8">Create your account to start customizing.</p>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            ...
            <Input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min. 6 characters" required minLength={6} className="bg-card border-border" />
          </div>
